pipeline {
  ...
  stages {
    ...
    stage('Test_Kiuwan') {
      steps {
        echo 'Testing Kiuwan...'
	      kiuwan connectionProfileUuid: '9Fwr-0PNm', failureThreshold: 98.0, sourcePath: '/home/jenkins/jenkins_slave/workspace/Pipeline_Seguridad', unstableThreshold: 99.0
	  }
    }
